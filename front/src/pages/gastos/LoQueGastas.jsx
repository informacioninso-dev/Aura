  ...
  return (
    <div className="finance-shell">
      <div className="page-header">
        ...
        <p className="page-subtitle">Todo lo que sale, fijo o puntual.</p>
      </div>
      ...
      <div className="finance-tab-panel">
        {currentTab === 'puntuales' ? <GastosNoCorrientes embedded /> : <GastosCorrientes embedded />}
      </div>
    </div>
  )
}
