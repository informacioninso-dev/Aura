...
urlpatterns = [
    ...
    path('respaldo/exportar/', ExportarCuentaView.as_view(), name='respaldo-exportar'),
    path('respaldo/importar/', ImportarRespaldoView.as_view(), name='respaldo-importar'),
